...
namespace StatikManager
{
    public partial class App : Application
    {
        ...
        // Zentrales Log-File neben der EXE
        internal static readonly string LogDatei = Path.Combine(
            AppDomain.CurrentDomain.BaseDirectory, "StatikManager_Errors.log");
        ...
        /// <summary>
        /// Schreibt Fehler mit Zeitstempel und Kontext in das Log-File.
        ...
        internal static void LogFehler(string kontext, string details)
        {
            ...
            {
                string zeile =
                    $"[{DateTime.Now:yyyy-MM-dd HH:mm:ss.fff}] [{kontext}]\n" +
                    details +
                    $"\n{new string('─', 80)}\n";
